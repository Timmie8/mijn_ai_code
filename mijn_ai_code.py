...
def run_v2_analysis(ticker):
    ...
    try:
        ...
        if (ensemble > 75 or lstm > 70) and swing > 58: rec, col, ico = "BUY", "#39d353", "🚀"
...
# --- 6. MAIN DASHBOARD ---
st.title("🏹 AI Alpha Strategy Terminal")
...
if res_v2 and df_1h is not None:
    ...
    with col_right:
        st.subheader("📅 1D Trend Confidence")
...
def show_live_list():
    st.subheader("🔄 Real-Time Watchlist Monitor (10s refresh)")
